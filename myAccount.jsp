<%-- 
    Document   : myAccount
    Created on : Sep 19, 2020, 10:41:06 PM
    Author     : Ukdmp Kasun
--%>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" readonly id="inputFirstName" type="text" value="<%=name %>"  />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputLastName">Phone Number</label>
                                                        <input class="form-control py-4" id="inputLastName" readonly value="<%=phone %>"  />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Email</label>
                                                <input class="form-control py-4" id="inputEmailAddress" readonly  value="<%=email %>" aria-describedby="emailHelp"  />
                                            </div>
